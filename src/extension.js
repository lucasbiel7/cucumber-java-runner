...
function activate(context) {
    ...
    let runFeatureCommand = vscode.commands.registerCommand('cucumberJavaEasyRunner.runFeature', async (uri) => {
        let featureUri = uri;
 ...
 */
async function runSelectedTest(uri, lineNumber, exampleLine) {
 ...
 */
function findScenarioAtLine(document, line) {
 ...
 */
function findExampleAtLine(document, line) {
    try {
        const text = document.getText();
        const lines = text.split('\n');
 ...
 */
async function findGluePath(projectRoot) {
 ...
 */
async function findStepsDir(dir) {
